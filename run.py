...
def get_opts():
    ...
    parser.add_argument('--downscale_factor', type=float, default=0.25, help='the mpi size is orig_size * downscale_factor')
    parser.add_argument('--n_planes', type=int, default=10, help='number of mpi planes')
